...
install_requires = [
    'numpy','scipy>=0.16','Pillow','matplotlib', 'cython', 'pyproj', 'scikit-image', 'simplekml', 'joblib==0.7.1', 'basemap', 'scikit-learn', 'pyresample', 'dask', 'toolz', 'cPickle', 'pandas'
]
...
def setupPackage():
   setup(name='PyHum',
         ...
         package_data={'PyHum': ['*.SON', '*.DAT','*.h', '*.IDX', '*.txt']}
   )
