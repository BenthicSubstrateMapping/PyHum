...
#################################################
def humread(humfile, sonpath, cs2cs_args, c, draft, doplot, t, f, bedpick, flip_lr):
   ...
   print "this could take a long time for large files..."
   ...
   try:
      ...
      Zt, ind_low = makechunks(data_dwnlow)
      del data_dwnlow
   ...
   try:
      ...
      Zt, ind_hi = makechunks(data_dwnhi)
      del data_dwnhi
