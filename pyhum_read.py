...
if __name__ == '__main__': 
    ...
    try:
       opts, args = getopt.getopt(argv,"hi:s:c:d:p:")
         ...
         print 'pyhum_read.py -i <.DAT file> -s <sonpath (/where/*.SON/are/)> -c <cs2cs coordinate trandform arguments> -d <draft (m)> -p <do plots, 0=no or 1=yes>'
         sys.exit(2)
    for opt, arg in opts:
       if opt == '-h':
         print 'pyhum_read.py -i <.DAT file> -s <sonpath (/where/*.SON/are/)> -c <cs2cs coordinate trandform arguments> -d <draft (m)> -p <do plots, 0=no or 1=yes>'
    ...
    if doplot==1:
       ...
       if ny>10000:
          Z,inds = sliding_window(data_star,(nx,10000))
          del nx, ny, inds
       ...
       if 'data_dwnlow' in locals():
          ...
          if ny>10000:
             Z,inds = sliding_window(data_dwnlow,(nx,10000))
             del nx, ny, inds
       ...
       if 'data_dwnhi' in locals():
          ...
          if ny>10000:
             Z,inds = sliding_window(data_dwnhi,(nx,10000))
             del nx, ny, inds
